...
init model =
    let
        data =
            Decode.decodeString Decode.value "{\"meta\":{},\"data\":{\"infosec\":{},\"details\":{\"contactName\":\"a\",\"companyName\":\"a\"},\"services\":{\"offered\":{\"description\":\"asdf\",\"selected\":[\"other\"]}}}}"
        ...
        data_ =
            Result.withDefault (Encode.string "fail") data

        -- t =
        --     Debug.log "Decode Data" data_
        model_ =
            DataDecoder.decodeForm data_ model.formBuilder.state

        equal =
            DataCompare.areEqual model_.form model_.form
